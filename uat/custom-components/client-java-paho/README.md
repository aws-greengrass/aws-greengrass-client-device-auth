...
But because both clients are based on separated clients implemented in IoT device SDK and Eclipse Paho libraries it differs in protocol-level information provided to control.
