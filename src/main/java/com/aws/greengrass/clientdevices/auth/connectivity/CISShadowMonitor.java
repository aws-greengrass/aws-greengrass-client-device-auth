...
public class CISShadowMonitor {
    ...
    public CISShadowMonitor(MqttClient mqttClient, ExecutorService executorService,
        ...
        this(mqttClient, null, null, executorService,
                Coerce.toString(deviceConfiguration.getThingName()) + CIS_SHADOW_SUFFIX, connectivityInfoAggregator);
    ...
    private synchronized void processCISShadow(String version, Map<String, Object> desiredState) {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                RetryUtils.runWithRetry(GET_CONNECTIVITY_RETRY_CONFIG, connectivityInfoAggregator::getConnectivityInfo,
            ...
            try {
                for (CertificateGenerator cg : monitoredCertificateGenerators) {
                    cg.generateCertificate(connectivityInfoAggregator::getCachedHostAddresses,
